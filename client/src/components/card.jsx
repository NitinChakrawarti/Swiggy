    ...
    return (
        <div className='w-[273px] shrink-0 grow hover:scale-95 duration-300'>
            <div className="h-[182px] rounded-[15px] overflow-hidden relative ">
                <img src={"https://swiggy-images.vercel.app/images/"+props.image} className='w-full h-full object-cover' alt="" />
            ...
            <div className=" m-1 text-[23px] font-bold">
                {props.title}
            </div>
            <div className="m-1 flex items-center gap-1"><Star /> {props.rating}
                <span className="ml-2">
